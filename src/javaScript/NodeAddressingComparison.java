...
public class NodeAddressingComparison {
	...
	public static void main(String[] args) {
		...
		if (firstSession){
			...
			system.startSession();
			system.stage(input1,javaScript1,output1,false,threads,200);
			system.stage(output1,javaScript2,output2,false,threads,400);
			system.stage(output2,javaScript3,output3,true,threads,400);
			system.stage(output3,javaScript4,output4,true,threads,500);
			system.stage(output4,javaScript5,output5,false,threads,1400);
			system.endSession();
		}
		...
		system.startSession();
		system.stage(output3,javaScript4,output42,true,threads,500);
		system.stage(output42,javaScript5,output52,false,threads,1400);
		system.endSession();
	}
