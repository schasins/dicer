...
var func_a1 = function(url,rowId,xpath,url1,url2,targetInfoString,iMacrosTargetInfoString,similarityInfoString,ATAQVInfoString,votingXpath,imacrosXpath,similarityXpath,chandraXpath,similarityTextXpath,xpathXpath,xpathSuffixXpath,textXpath,classXpath,idXpath,xpathSiblingsXpath,similarityRegressionXpath,similaritySvmXpath){
	return url+"<,>"+rowId+"<,>"+xpath+"<,>"+url1+"<,>"+url2+"<,>"+targetInfoString+"<,>"+iMacrosTargetInfoString+"<,>"+similarityInfoString+"<,>"+ATAQVInfoString+"<,>"+votingXpath+"<,>"+imacrosXpath+"<,>"+similarityXpath+"<,>"+chandraXpath+"<,>"+similarityTextXpath+"<,>"+xpathXpath+"<,>"+xpathSuffixXpath+"<,>"+textXpath+"<,>"+classXpath+"<,>"+idXpath+"<,>"+xpathSiblingsXpath+"<,>"+similarityRegressionXpath+"<,>"+similaritySvmXpath;
};

//the (original, Shaon) PLDI paper algorithm

var func_b1 = function(url,rowId,xpath,url1,url2,targetInfoString,iMacrosTargetInfoString,similarityInfoString,ATAQVInfoString,votingXpath,imacrosXpath,similarityXpath,chandraXpath,similarityTextXpath,xpathXpath,xpathSuffixXpath,textXpath,classXpath,idXpath,xpathSiblingsXpath,similarityRegressionXpath,similaritySvmXpath){
	var target = xPathToNodes(votingXpath);
...
var func_b2 = function(url,rowId,xpath,url1,url2,targetInfoString,iMacrosTargetInfoString,similarityInfoString,ATAQVInfoString,votingXpath,imacrosXpath,similarityXpath,chandraXpath,similarityTextXpath,xpathXpath,xpathSuffixXpath,textXpath,classXpath,idXpath,xpathSiblingsXpath,similarityRegressionXpath,similaritySvmXpath){
...
var func_c1 = function(url,rowId,xpath,url1,url2,targetInfoString,iMacrosTargetInfoString,similarityInfoString,ATAQVInfoString,votingXpath,imacrosXpath,similarityXpath,chandraXpath,similarityTextXpath,xpathXpath,xpathSuffixXpath,textXpath,classXpath,idXpath,xpathSiblingsXpath,similarityRegressionXpath,similaritySvmXpath){
	var target = xPathToNodes(imacrosXpath);
	if (target.length < 1 || target[0] == null) { return; } //won't click, so we'll get that the url is the same as the original
	simulateClick(target[0]);
};

var func_c2 = function(url,rowId,xpath,url1,url2,targetInfoString,iMacrosTargetInfoString,similarityInfoString,ATAQVInfoString,votingXpath,imacrosXpath,similarityXpath,chandraXpath,similarityTextXpath,xpathXpath,xpathSuffixXpath,textXpath,classXpath,idXpath,xpathSiblingsXpath,similarityRegressionXpath,similaritySvmXpath){
	var url3 = window.location.href;
	return url3;
};
...
var func_d1 = function(url,rowId,xpath,url1,url2,targetInfoString,iMacrosTargetInfoString,similarityInfoString,ATAQVInfoString,votingXpath,imacrosXpath,similarityXpath,chandraXpath,similarityTextXpath,xpathXpath,xpathSuffixXpath,textXpath,classXpath,idXpath,xpathSiblingsXpath,similarityRegressionXpath,similaritySvmXpath){
	var target = xPathToNodes(similarityXpath);
	if (target.length < 1 || target[0] == null) { return; } //won't click, so we'll get that the url is the same as the original
	simulateClick(target[0]);
};

var func_d2 = function(url,rowId,xpath,url1,url2,targetInfoString,iMacrosTargetInfoString,similarityInfoString,ATAQVInfoString,votingXpath,imacrosXpath,similarityXpath,chandraXpath,similarityTextXpath,xpathXpath,xpathSuffixXpath,textXpath,classXpath,idXpath,xpathSiblingsXpath,similarityRegressionXpath,similaritySvmXpath){
	var url3 = window.location.href;
	return url3;
};
...
var func_e1 = function(url,rowId,xpath,url1,url2,targetInfoString,iMacrosTargetInfoString,similarityInfoString,ATAQVInfoString,votingXpath,imacrosXpath,similarityXpath,chandraXpath,similarityTextXpath,xpathXpath,xpathSuffixXpath,textXpath,classXpath,idXpath,xpathSiblingsXpath,similarityRegressionXpath,similaritySvmXpath){
	var target = xPathToNodes(chandraXpath);
	if (target.length < 1 || target[0] == null) { return; } //won't click, so we'll get that the url is the same as the original
	simulateClick(target[0]);
};

var func_e2 = function(url,rowId,xpath,url1,url2,targetInfoString,iMacrosTargetInfoString,similarityInfoString,ATAQVInfoString,votingXpath,imacrosXpath,similarityXpath,chandraXpath,similarityTextXpath,xpathXpath,xpathSuffixXpath,textXpath,classXpath,idXpath,xpathSiblingsXpath,similarityRegressionXpath,similaritySvmXpath){
	var url3 = window.location.href;
	return url3;
};
...
var func_f1 = function(url,rowId,xpath,url1,url2,targetInfoString,iMacrosTargetInfoString,similarityInfoString,ATAQVInfoString,votingXpath,imacrosXpath,similarityXpath,chandraXpath,similarityTextXpath,xpathXpath,xpathSuffixXpath,textXpath,classXpath,idXpath,xpathSiblingsXpath,similarityRegressionXpath,similaritySvmXpath){
	var target = xPathToNodes(similarityTextXpath);
	if (target.length < 1 || target[0] == null) { return; } //won't click, so we'll get that the url is the same as the original
	simulateClick(target[0]);
};

var func_f2 = function(url,rowId,xpath,url1,url2,targetInfoString,iMacrosTargetInfoString,similarityInfoString,ATAQVInfoString,votingXpath,imacrosXpath,similarityXpath,chandraXpath,similarityTextXpath,xpathXpath,xpathSuffixXpath,textXpath,classXpath,idXpath,xpathSiblingsXpath,similarityRegressionXpath,similaritySvmXpath){
	var url3 = window.location.href;
	return url3;
};
...
var func_g1 = function(url,rowId,xpath,url1,url2,targetInfoString,iMacrosTargetInfoString,similarityInfoString,ATAQVInfoString,votingXpath,imacrosXpath,similarityXpath,chandraXpath,similarityTextXpath,xpathXpath,xpathSuffixXpath,textXpath,classXpath,idXpath,xpathSiblingsXpath,similarityRegressionXpath,similaritySvmXpath){
	var target = xPathToNodes(xpathXpath);
	if (target.length < 1 || target[0] == null) { return; } //won't click, so we'll get that the url is the same as the original
	simulateClick(target[0]);
};

var func_g2 = function(url,rowId,xpath,url1,url2,targetInfoString,iMacrosTargetInfoString,similarityInfoString,ATAQVInfoString,votingXpath,imacrosXpath,similarityXpath,chandraXpath,similarityTextXpath,xpathXpath,xpathSuffixXpath,textXpath,classXpath,idXpath,xpathSiblingsXpath,similarityRegressionXpath,similaritySvmXpath){
	var url3 = window.location.href;
	return url3;
};

var func_h1 = function(url,rowId,xpath,url1,url2,targetInfoString,iMacrosTargetInfoString,similarityInfoString,ATAQVInfoString,votingXpath,imacrosXpath,similarityXpath,chandraXpath,similarityTextXpath,xpathXpath,xpathSuffixXpath,textXpath,classXpath,idXpath,xpathSiblingsXpath,similarityRegressionXpath,similaritySvmXpath){
	var target = xPathToNodes(xpathSuffixXpath);
	if (target.length < 1 || target[0] == null) { return; } //won't click, so we'll get that the url is the same as the original
	simulateClick(target[0]);
};

var func_h2 = function(url,rowId,xpath,url1,url2,targetInfoString,iMacrosTargetInfoString,similarityInfoString,ATAQVInfoString,votingXpath,imacrosXpath,similarityXpath,chandraXpath,similarityTextXpath,xpathXpath,xpathSuffixXpath,textXpath,classXpath,idXpath,xpathSiblingsXpath,similarityRegressionXpath,similaritySvmXpath){
	var url3 = window.location.href;
	return url3;
};

var func_i1 = function(url,rowId,xpath,url1,url2,targetInfoString,iMacrosTargetInfoString,similarityInfoString,ATAQVInfoString,votingXpath,imacrosXpath,similarityXpath,chandraXpath,similarityTextXpath,xpathXpath,xpathSuffixXpath,textXpath,classXpath,idXpath,xpathSiblingsXpath,similarityRegressionXpath,similaritySvmXpath){
	var target = xPathToNodes(textXpath);
	if (target.length < 1 || target[0] == null) { return; } //won't click, so we'll get that the url is the same as the original
	simulateClick(target[0]);
};

var func_i2 = function(url,rowId,xpath,url1,url2,targetInfoString,iMacrosTargetInfoString,similarityInfoString,ATAQVInfoString,votingXpath,imacrosXpath,similarityXpath,chandraXpath,similarityTextXpath,xpathXpath,xpathSuffixXpath,textXpath,classXpath,idXpath,xpathSiblingsXpath,similarityRegressionXpath,similaritySvmXpath){
	var url3 = window.location.href;
	return url3;
};

var func_j1 = function(url,rowId,xpath,url1,url2,targetInfoString,iMacrosTargetInfoString,similarityInfoString,ATAQVInfoString,votingXpath,imacrosXpath,similarityXpath,chandraXpath,similarityTextXpath,xpathXpath,xpathSuffixXpath,textXpath,classXpath,idXpath,xpathSiblingsXpath,similarityRegressionXpath,similaritySvmXpath){
	var target = xPathToNodes(classXpath);
	if (target.length < 1 || target[0] == null) { return; } //won't click, so we'll get that the url is the same as the original
	simulateClick(target[0]);
};

var func_j2 = function(url,rowId,xpath,url1,url2,targetInfoString,iMacrosTargetInfoString,similarityInfoString,ATAQVInfoString,votingXpath,imacrosXpath,similarityXpath,chandraXpath,similarityTextXpath,xpathXpath,xpathSuffixXpath,textXpath,classXpath,idXpath,xpathSiblingsXpath,similarityRegressionXpath,similaritySvmXpath){
	var url3 = window.location.href;
	return url3;
};

var func_k1 = function(url,rowId,xpath,url1,url2,targetInfoString,iMacrosTargetInfoString,similarityInfoString,ATAQVInfoString,votingXpath,imacrosXpath,similarityXpath,chandraXpath,similarityTextXpath,xpathXpath,xpathSuffixXpath,textXpath,classXpath,idXpath,xpathSiblingsXpath,similarityRegressionXpath,similaritySvmXpath){
	var target = xPathToNodes(idXpath);
	if (target.length < 1 || target[0] == null) { return; } //won't click, so we'll get that the url is the same as the original
	simulateClick(target[0]);
};

var func_k2 = function(url,rowId,xpath,url1,url2,targetInfoString,iMacrosTargetInfoString,similarityInfoString,ATAQVInfoString,votingXpath,imacrosXpath,similarityXpath,chandraXpath,similarityTextXpath,xpathXpath,xpathSuffixXpath,textXpath,classXpath,idXpath,xpathSiblingsXpath,similarityRegressionXpath,similaritySvmXpath){
	var url3 = window.location.href;
	return url3;
};

var func_l1 = function(url,rowId,xpath,url1,url2,targetInfoString,iMacrosTargetInfoString,similarityInfoString,ATAQVInfoString,votingXpath,imacrosXpath,similarityXpath,chandraXpath,similarityTextXpath,xpathXpath,xpathSuffixXpath,textXpath,classXpath,idXpath,xpathSiblingsXpath,similarityRegressionXpath,similaritySvmXpath){
	var target = xPathToNodes(xpathSiblingsXpath);
	if (target.length < 1 || target[0] == null) { return; } //won't click, so we'll get that the url is the same as the original
	simulateClick(target[0]);
};

var func_l2 = function(url,rowId,xpath,url1,url2,targetInfoString,iMacrosTargetInfoString,similarityInfoString,ATAQVInfoString,votingXpath,imacrosXpath,similarityXpath,chandraXpath,similarityTextXpath,xpathXpath,xpathSuffixXpath,textXpath,classXpath,idXpath,xpathSiblingsXpath,similarityRegressionXpath,similaritySvmXpath){
	var url3 = window.location.href;
	return url3;
};
...
var func_m1 = function(url,rowId,xpath,url1,url2,targetInfoString,iMacrosTargetInfoString,similarityInfoString,ATAQVInfoString,votingXpath,imacrosXpath,similarityXpath,chandraXpath,similarityTextXpath,xpathXpath,xpathSuffixXpath,textXpath,classXpath,idXpath,xpathSiblingsXpath,similarityRegressionXpath,similaritySvmXpath){
	var target = xPathToNodes(similarityRegressionXpath);
	if (target.length < 1 || target[0] == null) { return; } //won't click, so we'll get that the url is the same as the original
	simulateClick(target[0]);
};

var func_m2 = function(url,rowId,xpath,url1,url2,targetInfoString,iMacrosTargetInfoString,similarityInfoString,ATAQVInfoString,votingXpath,imacrosXpath,similarityXpath,chandraXpath,similarityTextXpath,xpathXpath,xpathSuffixXpath,textXpath,classXpath,idXpath,xpathSiblingsXpath,similarityRegressionXpath,similaritySvmXpath){
	var url3 = window.location.href;
	return url3;
};

var func_n1 = function(url,rowId,xpath,url1,url2,targetInfoString,iMacrosTargetInfoString,similarityInfoString,ATAQVInfoString,votingXpath,imacrosXpath,similarityXpath,chandraXpath,similarityTextXpath,xpathXpath,xpathSuffixXpath,textXpath,classXpath,idXpath,xpathSiblingsXpath,similarityRegressionXpath,similaritySvmXpath){
	var target = xPathToNodes(similaritySvmXpath);
	if (target.length < 1 || target[0] == null) { return; } //won't click, so we'll get that the url is the same as the original
	simulateClick(target[0]);
};

var func_n2 = function(url,rowId,xpath,url1,url2,targetInfoString,iMacrosTargetInfoString,similarityInfoString,ATAQVInfoString,votingXpath,imacrosXpath,similarityXpath,chandraXpath,similarityTextXpath,xpathXpath,xpathSuffixXpath,textXpath,classXpath,idXpath,xpathSiblingsXpath,similarityRegressionXpath,similaritySvmXpath){
	var url3 = window.location.href;
	return url3;
};