...
var func_a1 = function(url,xpath,url1,url2,targetInfoString,iMacrosTargetInfoString,similarityInfoString){
	return url+"<,>"+xpath+"<,>"+url1+"<,>"+url2+"<,>"+targetInfoString+"<,>"+iMacrosTargetInfoString+"<,>"+similarityInfoString;
};
...
var func_d2 = function(url,xpath,url1,url2,targetInfoString,iMacrosTargetInfoString,similarityInfoString){
	var url3 = window.location.href;
	return url3;
};
